...
def main():
    ...
    parser.add_argument('--rwfm_set', action='store_true', default=False)
    parser.add_argument('--print_labels', action='store_true', default=False)
    ...
    result = common.init_build_directory(args.plat, args.tut, args.solution, os.getcwd(), args.rwfm_set, args.print_labels)
