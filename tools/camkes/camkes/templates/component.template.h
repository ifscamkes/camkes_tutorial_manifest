...
typedef struct object {
    ...
    int readers;               //the bits in places of readers are 1
    int writers;               //the bits in places of writers are 1
} OBJECT;

typedef struct RWFM_MONITOR
{
  int num_subjects;
  int num_objects;
  SUBJECT subjects[/*? rwfm.num_subjects ?*/];
  OBJECT objects[/*? rwfm.num_objects ?*/];
}RWFM;
